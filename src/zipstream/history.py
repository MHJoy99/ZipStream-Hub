...
# Default path is in user data / workspace root or package directory
DEFAULT_DB_PATH = Path(__file__).resolve().parent.parent.parent / "history.db" if (Path(__file__).resolve().parent.parent.name == "src") else Path(__file__).resolve().parent / "history.db"
